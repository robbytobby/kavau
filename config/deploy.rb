...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', 'config/secrets.yml', 'config/settings.yml', 'app/assets/images/logo.png', 'app/assets/images/stempel.png')
