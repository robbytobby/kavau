...
RSpec.describe PaymentPdf do
  ...
  before :each do
    ...
    @payment = create :deposit, amount: 2000, credit_agreement: @credit_agreement, date: Date.today
    letter_content = '#PROJEKT_N received #BETRAG at #DATUM'
    @letter = create :payment_letter, content: letter_content, subject: 'TheSubject'
