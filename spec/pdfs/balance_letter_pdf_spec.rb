...
RSpec.describe BalanceLetterPdf do
  ...
  describe "cecks for missing requiremens" do
    before :each do
      @creditor = create :person
      @project_address = create :project_address, :with_legals, :with_contacts, legal_form: 'registered_society'
      @account = create :account, address: @project_address, default: true
  ...
  describe "content" do
    ...
    it "has the right content" do
      ...
      expect(text_analysis).to include("Dr. Albert Meier hat dem Das Projekt e.V. einen zinsgünstigen Direktkredit zur")
