class AddDefaultSettings < ActiveRecord::Migration
  ...
  def defaults
    [ 
      ...
      letter: [
        {number: 5.1, group: 'layout', name: 'top_margin'    , type: 'FloatSetting', obligatory: 'true', unit: 'cm', default: '2'},
        {number: 5.2, group: 'layout', name: 'bottom_margin', type: 'FloatSetting', obligatory: 'true', unit: 'cm', default: '3.5'},
        {number: 5.3, group: 'layout', name: 'left_margin'   , type: 'FloatSetting', obligatory: 'true', unit: 'cm', default: '2'},
        {number: 5.4, group: 'layout', name: 'right_margin'  , type: 'FloatSetting', obligatory: 'true', unit: 'cm', default: '2'},
